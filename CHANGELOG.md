...
- Hardened native ComfyUI compatibility route policy so percent-encoded traversal, separator, query/fragment, and control-byte path forms are rejected before HTTP or WebSocket proxying.

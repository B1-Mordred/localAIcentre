...
LocalAI, ComfyUI, and Voicebox now have production runtime overrides. The current production template selects the RTX 3060 Laptop 6 GB / 32 GB profile for `ai.b1.germering`; see [docs/resource-profile-rtx3060-laptop-6gb-32gb.md](./docs/resource-profile-rtx3060-laptop-6gb-32gb.md). The original 12 GB profile remains documented as an upgrade target.

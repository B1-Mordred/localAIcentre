...
- validated required model profiles for every public alias class, exposed in the Control Center with target runtime, resource estimate, default safety limits, and selection guidance while exact GPU model choices remain replaceable pinned manifests

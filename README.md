...
- runtime-agent CPU/memory/disk/GPU metrics and Control Center system self-test with all required gateway TLS routes, tiny inference, dry-run unload, and artifact delivery probes

...
- production Voicebox Compose override and reproducible B1 image build from Jamie Pine Voicebox `v0.5.0` commit `2bcb98d1a8b6fe05e15fbc1559e3085669e4035d`, with native `:17493` API/web/MCP server behind the gateway, read-only runtime model views, B1-managed profile/generation/cache storage, and optional GPU reservation for managed TTS profiles

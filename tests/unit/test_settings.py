...
class SettingsTests(unittest.TestCase):
    ...
    def test_caddy_internal_ca_file_is_separate_from_self_test_ca(self) -> None:
        self.patch_env(
            ...
            B1_CADDY_INTERNAL_CA_FILE="/srv/b1-ai-hub/data/control-plane/caddy-root.crt",
        ...
        self.assertEqual(settings.caddy_internal_ca_file, "/srv/b1-ai-hub/data/control-plane/caddy-root.crt")

...
class ControlCenterSourceTests(unittest.TestCase):
    ...
    def test_runtimes_tab_surfaces_compose_selection_readiness(self) -> None:
        ...
        self.assertIn("lifecycleChecks", self.source)
        self.assertIn("payload.lifecycle_checks", self.source)
        ...
        self.assertIn("Lifecycle Hook Evidence", self.source)
    ...
    def test_system_tab_surfaces_acceptance_reports(self) -> None:
        ...
        self.assertIn("hasDhcpNetworkProof", self.source)
        self.assertIn("networking.has_dhcp_network_proof === true", self.source)
        self.assertIn("DHCP proof", self.source)
    ...
    def test_models_tab_supports_remote_manifest_url(self) -> None:
        ...
        self.assertIn("const [acceptModelLicense, setAcceptModelLicense]", self.source)
        self.assertIn("accept_license: acceptModelLicense", self.source)
        self.assertIn("Accept licence", self.source)
    ...
    def test_models_tab_runs_installed_model_smoke_tests(self) -> None:
        ...
        self.assertIn("required_runtimes?: string[]", self.source)
        ...
        self.assertIn("Required runtimes:", self.source)

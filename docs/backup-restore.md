...
- the cutover plan has no unresolved warnings, its core virtual-host DNS readiness is accepted, its hardware readiness is accepted, runtime-agent Docker socket group access is ready, and Open WebUI preservation no longer requires operator review

...
- observed host networking, including interfaces, non-loopback addresses, default routes, DHCP-route evidence, and an explicit policy that B1 AI Hub does not configure host static IP addresses
